...
public class MapPractice2 {
    ...
    public static void main(String[] args) {
        ...
        Object salaryOfElene = employees.get("Elena").get("salary");
        System.out.println(salaryOfElene);
        ...
        for (Map.Entry<String, Map<String, Object>> eachEntry : employees.entrySet()) {
            ...
            System.out.println(eachEntry.getKey() + " : " + eachEntry.getValue().get("job_title"));
        }
